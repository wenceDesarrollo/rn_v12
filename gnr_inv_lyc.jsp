...
response.setHeader ("Content-Disposition", "attachment;filename=\"Inventario_"+df.format(new Date())+".xls\"");
    ...
    <td width="650"><form id="form" name="form" method="post" action="inv_lyc.jsp?cla_uni=<%=request.getParameter("cla_uni")%>">
        ...
        <tr>
          <td height="90" colspan="8" bgcolor="#FFFFFF" class="logo style1">
            <div align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a name="Arriba" id="Arriba"></a>&nbsp;Inventario Unidad&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
          </tr>
        <tr>
          <td height="14" colspan="8" bgcolor="#D51045"><span class="style2"><span class="Estilo8"><!--span class="Estilo9">Exportar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span--><!--img src="icono_excel.gif" border="0" usemap="#Map2"/-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span><span class="Estilo8">&nbsp;&nbsp;<span class="Estilo8"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
          </tr>
        <tr>
          <td height="33">&nbsp;</td>
