            ...
            <form id="form" name="form" method="post" action="index_menu_receta.jsp">
                <table width="650" height="323" border="0" align="center" cellpadding="2">
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="style5"><label><a href="carga_abasto.jsp?id_usu=<%=request.getParameter("id_usu")%>&cla_uni=<%=request.getParameter("cla_uni")%>">ABASTO LOCAL</a></label></td>
                        <td class="style5">&nbsp;</td>
                    </tr>
                    <tr>
                        <td height="20">
                        ...
                        <td colspan="2" class="style5"><label><a href="abasto_web.jsp?id_usu=<%=request.getParameter("id_usu")%>&cla_uni=<%=request.getParameter("cla_uni")%>">ABASTO V&Iacute;A WEB</a>
                        </label></td>
                        <td>&nbsp;</td>
                    </tr>
