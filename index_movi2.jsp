    ...
    <td width="650"><form id="form" name="form" method="post" action="index_movi2.jsp">
      <table width="650" height="323" border="0" align="center" cellpadding="2">
        ...
        <tr>
          ...
          <td colspan="2" class="style5"><label><a href="carga_clave.jsp?id_usu=<%=request.getParameter("id_usu")%>&cla_uni=<%=request.getParameter("cla_uni")%>" target="_blank">ENTRADA MANUAL  POR AJUSTE</a></label></td>
          <td class="style5">&nbsp;</td>
        </tr>
        <tr>
          <td height="20"><div align="right">
          ...
          <td colspan="2" class="style5"><label><a href="descarga_clave.jsp?id_usu=<%=request.getParameter("id_usu")%>&cla_uni=<%=request.getParameter("cla_uni")%>" target="_blank">SALIDA MANUAL POR AJUSTE</a> </label></td>
          <td>&nbsp;</td>
        </tr> 
