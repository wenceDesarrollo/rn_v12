...
String but="";
String fol_rec="", nom_pac="", car_pac="", sex_pac = "", fec_nac="", folio_sp="", med1="", med2="";
...
if (but!=null){
    ...
    if (but.equals("Médico")){
        ...
        try{
            ...
            if (ban==0){
                stmt.execute("insert into receta values ('0', '"+fol_rec+"', '"+folio_sp+"', '"+request.getParameter("txtf_medico")+"', '1', '"+request.getParameter("id_usu")+"', '"+request.getParameter("txtf_cause")+"', '-', '"+request.getParameter("txtf_carnet")+"')");
                rset = stmt.executeQuery("select id_rec from receta where fol_rec = '"+fol_rec+"' and id_tip = '1' and id_usu = '"+request.getParameter("id_usu")+"' ");
                while (rset.next()){
						
                        stmt2.execute("insert into bitacora values('0', '"+rset.getString("id_rec")+"', '"+(df.format(df2.parse(request.getParameter("txtf_date1")))+" "+df3.format(new Date()))+"')");
                }
            }
    ...
    if (but.equals("Capturar")){
        ...
        try{
            String id_rec="";
            rset = stmt.executeQuery("SELECT i.id_inv, DP.det_pro, P.cla_pro, P.des_pro, DP.cad_pro, DP.lot_pro, I.cant, DP.cla_fin, DP.id_ori FROM detalle_productos DP, productos P, inventario I, unidades U, usuarios US WHERE I.cant !='0' and DP.cla_pro = P.cla_pro AND DP.det_pro = I.det_pro AND I.cla_uni = U.cla_uni AND US.cla_uni = U.cla_uni AND P.cla_pro = '"+request.getParameter("txtf_clave1")+"' AND US.id_usu='"+request.getParameter("id_usu")+"' ORDER BY  DP.id_ori, DP.cad_pro, I.cant ASC ");
            try{
            while (rset.next()){
                ...
                if(sol <= 0){
                    if (sol == 0 ){
                        ...
                        stmt2.execute("insert into kardex values ('0', '"+id_rec+"', '"+rset.getString("det_pro")+"', '"+sur+"', 'SALIDA RECETA', '-', NOW(), 'SALIDA POR RECETA FAR', '"+request.getParameter("id_usu")+"')");
                    }
                    if (sol < 0 ){
                        ...
                        stmt2.execute("insert into kardex values ('0', '"+id_rec+"', '"+rset.getString("det_pro")+"', '"+sol1+"', 'SALIDA RECETA', '-', NOW(), 'SALIDA POR RECETA FAR', '"+request.getParameter("id_usu")+"')");
                    }
                    break;
                }
                ...
                stmt2.execute("insert into kardex values ('0', '"+id_rec+"', '"+rset.getString("det_pro")+"', '"+rset.getString("cant")+"', 'SALIDA RECETA', '-', NOW(), 'SALIDA POR RECETA FAR', '"+request.getParameter("id_usu")+"')");
                stmt2.execute("update inventario set cant = '0' where id_inv = '"+rset.getString("id_inv")+"' ");
            }
            ...
            if (sol>0){
                ...
                stmt2.execute("insert into kardex values ('0', '"+id_rec+"', '"+det_pro+"', '0', 'SALIDA RECETA', '-', NOW(), 'SALIDA POR RECETA FAR', '"+request.getParameter("id_usu")+"')");
            }
        } catch (Exception e) {out.println(e.getMessage());}
    }
}
                        ...
                        <table width="854" height="45" border="0" align="center" cellpadding="2">
                            <tr>
                                ...
                                <td width="326" align="center" class="style2">Ingrese No. Folio
                                    <input name="txtf_foliore" id="txtf_foliore" type="text" class="style13"  value="<%=fol_rec%>" size="20" onKeyPress="return handleEnter(this, event)" autofocus="autofocus"/>
                    ...
                    <td height="38" colspan="3" class="style4"><table width="763" border="0" align="center" cellpadding="2">
                            <tr>
                                <td width="755" class="style2"><a href="medico.jsp" target="_blank">CÓDIGO</a>: 
                                    ...
                                    %>
                                    <input name="txtf_nomed" id="txtf_nomed" type="text" class="style13" value="<%=med1%>" size="35"  onKeyPress="return handleEnter(this, event)" readonly />
                                    <span class="style2">
                                        C&Eacute;DULA: 
                                        <input name="txtf_cedu" id="a" type="text" class="style13" value="<%=med2%>" size="10"  onKeyPress="return handleEnter(this, event)" readonly/>
                                    </span>
                                    <%
										}} catch (Exception e) {}
                                    %>
                ...
                <tr>
                    <td height="219" colspan="3" class="style4">
                        ...
                        <table width="875" border="0" align="center" cellpadding="2">
                            ...
                            <%
                            try{
                            rset = stmt.executeQuery("SELECT dr.fol_det, p.cla_pro, p.des_pro, dp.lot_pro, dp.cad_pro, dr.can_sol, dr.cant_sur, dr.status, o.des_ori from productos p, detalle_productos dp, detreceta dr, receta r, origen o where p.cla_pro = dp.cla_pro and dp.det_pro = dr.det_pro AND dr.id_rec = r.id_rec AND dp.id_ori = o.id_ori AND r.fol_rec = '"+request.getParameter("txtf_foliore")+"' and r.id_usu = '"+request.getParameter("id_usu")+"' ;");
                            while(rset.next()){
                            %>
                            <tr>
