    ...
    <td width="650"><form id="form" name="form" method="post" action="index_reporte_consumo.jsp">
      <table width="650" height="323" border="0" align="center" cellpadding="2">
        ...
        <tr>
          ...
          <td colspan="2" class="style5"><label><a href="dispensado.jsp?cla_uni=<%=request.getParameter("cla_uni")%>">CONSUMO  DIARIO RECETA POR FARMACIA</a></label></td>
          <td class="style5">&nbsp;</td>
        </tr>
        <tr>
          <td height="20"><div align="right">
          ...
          <td colspan="2" class="style5"><label><a href="dispensado_col.jsp?cla_uni=<%=request.getParameter("cla_uni")%>">CONSUMO  DIARIO RECETA COLECTIVA</a> </label></td>
          <td>&nbsp;</td>
        </tr>
