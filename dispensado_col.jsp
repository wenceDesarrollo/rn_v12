	...
	<a href="index_reporte_consumo.jsp?cla_uni=<%=request.getParameter("cla_uni")%>">Regresar a Menú </a>
      <table width="775" height="281" border="0" align="center" cellpadding="2">
        ...
        <tr>
		  ...
		  <td>
		    <div align="center"><a href="repor_dispensado_col.jsp?txtf_caduc=<%=f1%>&txtf_caduc=<%=f2%>&cla_uni=<%=request.getParameter("cla_uni")%>"><img src="imagenes/exc.jpg" width="37" height="29" border="0" alt="Exportar a Excel" /></a></div></td>
		  </tr>
		  <tr>
		  <td height="33">		  </td>
		  <td>
