...
<table width="40%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#CCFF99">
      ...
      <a href="reportes_farmacia.jsp" class="style76"><span class="Estilo1">Regresar a Menú</span></a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <%
	  String ori="AMBOS";
	  try{
    ...
    <table width="800" border="0" align="center">
      <tr>
        <td width="800"><table width="798" border="1">
			...
			<%
			rset = stmt.executeQuery("SELECT  bi.fec_carga, r.fol_rec, m.nom_med, pa.nom_pac, p.cla_pro, p.des_pro, dp.lot_pro, dp.cad_pro, dr.can_sol, dr.cant_sur FROM bitacora bi, unidades un, usuarios us, receta r, pacientes pa, medicos m, detreceta dr, detalle_productos dp, productos p WHERE bi.id_rec = r.id_rec and un.cla_uni = us.cla_uni AND us.id_usu = r.id_usu AND r.num_afi = pa.num_afi AND r.cedula = m.cedula AND r.id_rec = dr.id_rec AND dr.det_pro = dp.det_pro AND dp.cla_pro = p.cla_pro AND un.cla_uni = '"+request.getParameter("cla_uni")+"' AND bi.fec_carga BETWEEN '"+df.format(df2.parse(request.getParameter("txtf_caduc")))+" 00:00:01' and '"+df.format(df2.parse(request.getParameter("txtf_caduci")))+" 23:59:59' and dp.id_ori like '%"+request.getParameter("id_ori")+"%' and r.id_tip = '"+request.getParameter("reporte")+"' and dr.baja !=1 and dr.cant_sur!=0  ;");
			while(rset.next()){
				try{
			%>
            <tr>
