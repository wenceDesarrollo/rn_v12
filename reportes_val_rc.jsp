...
try{
	if (request.getParameter("reporte").equals("global")){
		response.sendRedirect("reporte_glob_rc_val.jsp?cla_uni="+request.getParameter("cla_uni")+"&f1="+request.getParameter("txtf_caduc")+"&f2="+request.getParameter("txtf_caduci")+"&ori="+request.getParameter("ori")+"");
	}
	if (request.getParameter("reporte").equals("receta")){
		response.sendRedirect("reporte_re2_rc_val.jsp?cla_uni="+request.getParameter("cla_uni")+"&f1="+request.getParameter("txtf_caduc")+"&f2="+request.getParameter("txtf_caduci")+"&ori="+request.getParameter("ori")+"");
	}
}catch(Exception e){}
  ...
  <tr bgcolor="#D5EDB3">
    ...
    <td height="50" colspan="3" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="right">
        <table width="946" border="0" align="left" cellpadding="2">
          <tr>
            <td width="792"><div align="center" class="style5 style6">SISTEMA REPORTEADOR DE VALIDACIONES POR MES RECETA COLECTIVA</div></td>
              ...
              <tr>
                ...
                <td width="638"><div align="center">
                    <table width="687" border="0" align="center" cellpadding="2" cellspacing="3">
                      <form action="reportes_val_rc.jsp" method="get" >
                        <tr>
