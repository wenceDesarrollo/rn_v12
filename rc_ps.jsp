...
if (but!=null){
	if (but.equals("Clave")||but.equals("Ver")){
        ...
        try{
            int ban = 0;
            rset = stmt.executeQuery("select id_rec from receta where fol_rec = '"+fol_rec+"' and id_tip = '2' and id_usu = '"+request.getParameter("id_usu")+"' ");
            while (rset.next()){
                ban = 1;
            }
            if (ban==0){
                stmt.execute("insert into receta values ('0', '"+fol_rec+"', '-', '-', '2', '"+request.getParameter("id_usu")+"', '1', '"+encargado+"','-')");
                rset = stmt.executeQuery("select id_rec from receta where fol_rec = '"+fol_rec+"' and id_tip = '2' and id_usu = '"+request.getParameter("id_usu")+"'");
                while (rset.next()){
                        stmt2.execute("insert into bitacora values('0', '"+rset.getString("id_rec")+"', NOW())");
                }
            }
	...
	if (but.equals("Capturar")){
        ...
        try{
            ...
            while (rset.next()){
                ...
                rset2 = stmt2.executeQuery("select id_rec from receta where fol_rec = '"+fol_rec+"' and id_tip = '2' and id_usu = '"+request.getParameter("id_usu")+"' ");
                while (rset2.next()){
                ...
                if(sol <= 0){
                    if (sol == 0 ){
                        ...
                        stmt2.execute("insert into kardex values ('0', '"+id_rec+"', '"+rset.getString("det_pro")+"', '"+sur+"', 'SALIDA RECETA', '-', NOW(), 'SALIDA POR RECETA COL', '"+request.getParameter("id_usu")+"')");
                    }
                    if (sol < 0 ){
                        ...
                        stmt2.execute("insert into kardex values ('0', '"+id_rec+"', '"+rset.getString("det_pro")+"', '"+sol1+"', 'SALIDA RECETA', '-', NOW(), 'SALIDA POR RECETA COL', '"+request.getParameter("id_usu")+"')");
                    }
                    break;
                }
                ...
                stmt2.execute("insert into kardex values ('0', '"+id_rec+"', '"+rset.getString("det_pro")+"', '"+rset.getString("cant")+"', 'SALIDA RECETA', '-', NOW(), 'SALIDA POR RECETA COL', '"+request.getParameter("id_usu")+"')");
                stmt2.execute("update inventario set cant = '0' where id_inv = '"+rset.getString("id_inv")+"' ");
            }
            ...
            if (sol>0){
                ...
                stmt2.execute("insert into kardex values ('0', '"+id_rec+"', '"+det_pro+"', '0', 'SALIDA RECETA', '-', NOW(), 'SALIDA POR RECETA COL', '"+request.getParameter("id_usu")+"')");
            }
        } catch (Exception e) {out.println(e.getMessage());}
    }
}
      ...
      <table width="763" height="61" border="0" align="center" cellpadding="2">
		...
		<table width="939" border="0" align="center" cellpadding="2">
            ...
            <tr>
              ...
              <td class="style11"><span class="style2">
                <input type="text" name="txtf_encarser" class="style2" size="60" value="<%=encargado%>" onChange="mayeE(this.form)" />
              </span></td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
            </tr>
      ...
      <tr>
        <td width="70" class="style11"><span class="letras"><span class="style2">CLAVE</span></span></td>
            ...
            <tr>
              ...
              <td class="style11"><input type="text" name="txtf_sol1" id="txtf_sol1" size="5" value="" onKeyPress="return validar(event)"  /></td>
            ...
            <tr class="letras">
              ...
              <%
                            try{
                            rset = stmt.executeQuery("SELECT dr.fol_det, p.cla_pro, p.des_pro, dp.lot_pro, dp.cad_pro, dr.can_sol, dr.cant_sur, dr.status, o.des_ori from productos p, detalle_productos dp, detreceta dr, receta r, origen o where p.cla_pro = dp.cla_pro and dp.det_pro = dr.det_pro AND dr.id_rec = r.id_rec AND dp.id_ori = o.id_ori AND r.fol_rec = '"+request.getParameter("txtf_foliore")+"' ;");
                            while(rset.next()){
                            %>
                            <tr>
                                ...
                                <td class="style2">
                                    <a href = "eliminar.jsp?fol_det=<%=rset.getString("fol_det")%>&id_usu=<%=rset.getString("fol_det")%>">Eliminar</a>
                                </td>
                            </tr>
                            <%
                            }}catch(Exception e){out.println(e.getMessage());}
