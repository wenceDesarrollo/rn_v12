    ...
    <td width="650"><form id="form" name="form" method="post" action="menu_mod_rc.jsp">
      <table width="650" height="323" border="0" align="center" cellpadding="2">
        ...
        <tr>
          ...
          <td colspan="2" class="style5"><label><a href="rc_elim.jsp?cla_uni=<%=request.getParameter("cla_uni")%>&id_usu=<%=request.getParameter("id_usu")%>">ELIMINAR FOLIO DE LA RECETA COLECTIVA</a></label></td>
          <td class="style5">&nbsp;</td>
        </tr>
        <tr>
          <td height="20"><div align="right">
          ...
          <td colspan="3" class="style5"><label><a href="rc_modi.jsp?cla_uni=<%=request.getParameter("cla_uni")%>&id_usu=<%=request.getParameter("id_usu")%>">MODIFICAR DATOS DE LA RECETA COLECTIVA (ENCABEZADO)</a></label></td>
          </tr>
        <tr>
          <td height="20"><div align="right">
            <div align="left" class="Estilo6"></div>
          </div></td>
          <td colspan="3" class="style5"><label><a href="rc_modi2.jsp?cla_uni=<%=request.getParameter("cla_uni")%>&id_usu=<%=request.getParameter("id_usu")%>">REINTEGRAR INSUMO AL INVENTARIO / ERROR DE CAPTURA / AGREGAR INSUMO</a> </label></td>
          </tr>
        <tr>
          <td height="20">&nbsp;</td>
